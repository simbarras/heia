...
class Esp32 {
   public:
    ...
    bool startBlePublisher(const char* name, bool autoAdvertising);
    bool initBlePublisher(const char* name);
    ...
    bool initBleSubscriber(const char* name);
    bool restoreBle();

...
public class BTree<T> {
    ...
    static class BTNode<T> {
        ...
        public BTNode(T e, BTNode<T> l, BTNode<T> r, BTNode<T> p) {
            elt = e;
            left = l;
            right = r;
            parent = p;
    ...
    private String toStr(BTNode n) {
        return n == null ? "()" : "(" + toStr(n.left) + "," + n.elt + "," + toStr(n.right) + ")";
    }

    // ------ toReadableString() [already implemented!] ------
  /* Example:
                        9
             2´´´´´´´´´´ ```````4
          12´ ``8            6´´ ```7

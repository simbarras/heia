...
import java.io.*;
public class TSP200Dump {
  static final String DUMPED_CLASSNAME="TSP200";
  //------------------------------------------------------------
  public static byte[] dump () throws Exception {
    ...
    //----- default constructor
    {
      ...
      ;   mv.visitLabel(line02); mv.visitLineNumber(2, line02);
    ...
    //----- the saleseman() method
    {
      ...
      mv.visitCode();
      ;   mv.visitLabel(line08); mv.visitLineNumber(8, line08);
      mv.visitVarInsn  (ALOAD, var_t0);
      mv.visitInsn     (ARRAYLENGTH);
      mv.visitVarInsn  (ISTORE, var_n);
      ;   mv.visitLabel(line09); mv.visitLineNumber(9, line09);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitIntInsn  (NEWARRAY, T_DOUBLE);
      mv.visitVarInsn  (ASTORE, var_tx);
      ;   mv.visitLabel(line10); mv.visitLineNumber(10, line10);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitIntInsn  (NEWARRAY, T_DOUBLE);
      mv.visitVarInsn  (ASTORE, var_ty);
      ;   mv.visitLabel(line11); mv.visitLineNumber(11, line11);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitIntInsn  (NEWARRAY, T_INT);
      mv.visitVarInsn  (ASTORE, var_ti);
      ;   mv.visitLabel(line12); mv.visitLineNumber(12, line12);
      mv.visitInsn     (ICONST_0);
      mv.visitVarInsn  (ISTORE, var_closestPt);
      ;   mv.visitLabel(line14); mv.visitLineNumber(14, line14);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitInsn     (ICONST_1);
      mv.visitInsn     (ISUB);
      mv.visitVarInsn  (ISTORE, var_highPt);
      ;   mv.visitLabel(line17); mv.visitLineNumber(17, line17);
      mv.visitInsn     (ICONST_0);
      mv.visitVarInsn  (ISTORE, var_i);
      ;   mv.visitLabel(l7);
      mv.visitJumpInsn (GOTO, l8);
      ;   mv.visitLabel(line18); mv.visitLineNumber(18, line18);
      ...
      ;   mv.visitLabel(line19); mv.visitLineNumber(19, line19);
      ...
      mv.visitInsn     (DASTORE);
      ;   mv.visitLabel(line20); mv.visitLineNumber(20, line20);
      mv.visitVarInsn  (ALOAD, var_ti);
      mv.visitVarInsn  (ILOAD, var_i);
      mv.visitVarInsn  (ILOAD, var_i);
      mv.visitInsn     (IASTORE);
      ;   mv.visitLabel(line17a); mv.visitLineNumber(17, line17a);
      mv.visitIincInsn(var_i, 1);
      ;   mv.visitLabel(l8);
      mv.visitVarInsn  (ILOAD, var_i);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitJumpInsn (IF_ICMPLT, line18);
      ;   mv.visitLabel(line22); mv.visitLineNumber(22, line22);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitInsn     (ICONST_1);
      mv.visitInsn     (ISUB);
      mv.visitVarInsn  (ISTORE, var_thisPt);
      ;  mv.visitLabel(line23); mv.visitLineNumber(23, line23);
      ...
      mv.visitInsn     (ISUB);
      mv.visitInsn     (IASTORE);
      ;  mv.visitLabel(line24); mv.visitLineNumber(24, line24);
      mv.visitJumpInsn (GOTO, line24b);
      ;  mv.visitLabel(line25); mv.visitLineNumber(25, line25);
      mv.visitLdcInsn(Double.valueOf(Double.MAX_VALUE));
      mv.visitVarInsn  (DSTORE, var_shortestDist);
      ;  mv.visitLabel(line26); mv.visitLineNumber(26, line26);
      mv.visitVarInsn  (ALOAD, var_tx);
      ...
      ;   mv.visitLabel(line27); mv.visitLineNumber(27, line27);
      mv.visitInsn     (ICONST_0);
      mv.visitVarInsn  (ISTORE, var_j);
      ;   mv.visitLabel(line28); mv.visitLineNumber(28, line28);
      ...
      ;   mv.visitLabel(line29); mv.visitLineNumber(29, line29);
      ...
      ;   mv.visitLabel(line30); mv.visitLineNumber(30, line30);
      mv.visitVarInsn  (DLOAD, var_d);
      ...
      mv.visitInsn     (DADD);
      mv.visitVarInsn  (DSTORE, var_d);
      ;   mv.visitLabel(line31); mv.visitLineNumber(31, line31);
      mv.visitVarInsn  (DLOAD, var_d);
      mv.visitVarInsn  (DLOAD, var_shortestDist);
      mv.visitInsn     (DCMPL);
      mv.visitJumpInsn (IFLE, line32);
      mv.visitJumpInsn (GOTO, line27b);
      ;   mv.visitLabel(line32); mv.visitLineNumber(32, line32);
      mv.visitVarInsn  (ILOAD, var_j);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitJumpInsn (IF_ICMPNE, line33);
      mv.visitJumpInsn (GOTO, line36);
      ;   mv.visitLabel(line33); mv.visitLineNumber(33, line33);
      mv.visitVarInsn  (DLOAD, var_d);
      mv.visitVarInsn  (DSTORE, var_shortestDist);
      ;   mv.visitLabel(line34); mv.visitLineNumber(34, line34);
      mv.visitVarInsn  (ILOAD, var_j);
      mv.visitVarInsn  (ISTORE, var_closestPt);
      ;   mv.visitLabel(line27b); mv.visitLineNumber(27, line27b);
      mv.visitIincInsn (var_j, 1);
      ;   mv.visitLabel(l30);
      mv.visitJumpInsn (GOTO, line28);
      ;   mv.visitLabel(line36); mv.visitLineNumber(36, line36);
      mv.visitVarInsn  (ALOAD, var_path);
      mv.visitVarInsn  (ILOAD, var_n);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitInsn     (ISUB);
      ...
      mv.visitInsn     (IALOAD);
      mv.visitInsn     (IASTORE);
      ;   mv.visitLabel(line37); mv.visitLineNumber(37, line37);
      mv.visitIincInsn (var_highPt, -1);
      ;   mv.visitLabel(line38); mv.visitLineNumber(38, line38);
      mv.visitVarInsn  (ALOAD, var_tx);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitInsn     (DALOAD);
      ...
      mv.visitInsn     (DASTORE);
      ;   mv.visitLabel(line39); mv.visitLineNumber(39, line39);
      mv.visitVarInsn  (ALOAD, var_ty);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitInsn     (DALOAD);
      mv.visitVarInsn  (DSTORE, var_aux);
      ...
      mv.visitVarInsn  (DLOAD, var_aux);
      mv.visitInsn     (DASTORE);
      ;   mv.visitLabel(line40); mv.visitLineNumber(40, line40);
      mv.visitVarInsn  (ALOAD, var_ti);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitInsn     (IALOAD);
      ...
      mv.visitInsn     (IASTORE);
      ;   mv.visitLabel(line41); mv.visitLineNumber(41, line41);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitVarInsn  (ISTORE, var_thisPt);
      ;   mv.visitLabel(line24b); mv.visitLineNumber(24, line24b);
      mv.visitVarInsn  (ILOAD, var_highPt);
      mv.visitJumpInsn (IFGT, line25);
      ;   mv.visitLabel(line43); mv.visitLineNumber(43, line43);
      mv.visitInsn     (RETURN);
      ;   mv.visitLabel(l39);
